...
const { createListing, getListingsByCategory, getAllListings, getSingleListing, getListingsByUser, deleteListing, getAllListingsAdmin, updateListing } = require('../Controllers/Listing');
const router = express.Router();
const Authenticate = require('../authenticate/authenticate');

router.get('/listings/',getAllListings);
router.get('/listingsadmin/',getAllListingsAdmin);
