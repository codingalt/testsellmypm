...
const Pricing = () => {
  ...
  const handleAuth = ()=>{
    if(!isAuthenticated){
      setModalShow(false)
      toastHandle(false, "You are not logged in! Please login first or signup if you don't have an account");
      navigate('/login');
    }else{
      setModalShow(true)
    }
    ...
    <div ref={memberShipRef} className='pricing-wrapper'>
      ...
      <PaymentModal show={modalShow} onHide={() => setModalShow(false)} />
       <div className="section-header mb-4 pb-2">
          <h2 data-aos="fade-left" data-aos-duration="900" className="section-title">Simple, transparent pricing</h2>
          <h6 data-aos="fade-right" data-aos-duration="900" className='section-title-h6'>Whether it's your first time selling or buying, we've got the right  plan for you</h6>
        </div>
   <div className="p-inner">
    <div data-aos="fade-up" data-aos-duration="1700" className="p-table basic" style={{boxShadow:'none',background:'transparent'}}>
      ...
      <div className="package-name pkg-name1" style={{border:'none',background:'none'}}></div>
      <ul data-aos="fade-up" data-aos-duration="1750" className="features feature1" style={{border:'none'}}>
        <li>
    ...
    <div data-aos="fade-up" data-aos-duration="2000" className="p-table premium">
      ...
      <ul data-aos="fade-up" data-aos-duration="2050" className="features">
        <li>
          <span className="list-name list-name-1">Property Managers ready to buy or sell</span>
          <span className="list-name list-name-1">Property Managers ready to buy or sell</span>
      ...
      <div className="btn"><button onClick={handleAuth}>Choose Plan</button></div>
    </div>
    <div data-aos="fade-up" data-aos-duration="2100" className="p-table ultimate">
      <div className="price-section">
        <div className="price-area">
          <div className="inner-area">
            <span className="text">$</span>
      ...
      <ul data-aos="fade-up" data-aos-duration="2150" className="features">
        <li>
        <span className="list-name list-name-1">Aspiring buyers and sellers</span>
          <span className="list-name list-name-1">Aspiring buyers and sellers</span>
          {/* <span className="icon cross"><ai.AiOutlineClose /></span> */}
        </li>
        <li>
      ...
      <div className="btn"><button>Choose Plan</button></div>
      </NavLink>
    </div>
  </div>
