...
const Cards = () => {
  ...
  return (
    <>
      ...
      {!myListings.length === 0 && !loader && !isAdmin && <NoListing />}

      {!myListings.length !== 0 && !loader && !isAdmin && <MyListings />}
    </>
  );
};
