      ...
      <div className="advisor-card shadow-sm">
        ...
        <div className="a-details">
          <div className="c-profile">
            <img
              src={loading ? loadingProfile : advisors.profilePicture?.url}
              alt=""
            />
          </div>
          <div className="info">
            ...
            <div className="card-title">{advisors?.title}</div>
        ...
        <div className="expertise">
          <span>Expertise</span>
          <span>
            {advisors?.expertise[0]}, {advisors?.expertise[1]},{" "}
            {advisors?.expertise[2]}, {advisors?.expertise[3]}
          </span>
        </div>
