...
const Sidebar = ({ isAvailable }) => {
  const [activeLink, setActiveLink] = useState("");
  const { isAdmin } = useContext(MainContext);
  let pathname = window.location.pathname;
  const { isOpen, toggle, sidebarRef } = useContext(sidebarContext);
            ...
            >
              {isAdmin ? (
                <>
                  <li
                    className={
                      pathname.match("/dashboard") ? "active-sidebar-li" : ""
                    }
                  >
                    <NavLink
                      to="/dashboard"
                      className={pathname.match("/dashboard") ? "white" : ""}
                    >
                      <span
                        className={pathname.match("/dashboard") ? "white" : ""}
                      >
                  ...
                  <li
                    className={
                      pathname.match("/auth/admin/managelisting")
                        ? "active-sidebar-li"
                        : ""
                    }
                  >
                    <NavLink
                      to="/auth/admin/managelisting"
                      className={
                        pathname.match("/auth/admin/managelisting")
                          ? "white"
                          : ""
                  ...
                  <li
                    className={
                      pathname.match("/auth/admin/createadvisor")
                        ? "active-sidebar-li"
                        : ""
                    }
                  >
                    <NavLink
                      to="/auth/admin/createadvisor"
                      className={
                        pathname.match("/auth/admin/createadvisor")
                          ? "white"
                          : ""
                ...
                <>
                  ...
                  >
                    <NavLink
                      to="/buyerrequests"
                      className={
                        pathname.match("/buyerrequests") ? "white" : ""
                      }
                    >
                      <span
                        className={
                  ...
                  <li
                    className={
                      pathname.match("/chat") ? "active-sidebar-li" : ""
                    }
                  >
                    <NavLink
                      to="/chat"
                  ...
                  <li
                    className={
                      pathname.match("/approvedrequests")
                        ? "active-sidebar-li"
                        : ""
                    }
                  >
                    <NavLink
                      to="/approvedrequests"
                      className={
                        pathname.match("/approvedrequests") ? "white" : ""
                      }
                    >
                      <span
                        className={
                  ...
                  <li
                    className={
                      pathname === "/listing" ? "active-sidebar-li" : ""
                    }
                  >
                    <NavLink
                      to={"/listing"}
