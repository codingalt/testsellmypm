        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="title">
            ...
            <p className="advert-detail">
              We’re going to help you create an appealing advert which will
              encourage interested parties to get in touch.{" "}
            </p>
          </div>
          <div className="title">
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="saleDetails.quickSaleNeed"
                  onChange={formik.handleChange}
                  value={formik.values.saleDetails.quickSaleNeed}
                >
          ...
          <div className="title">
            ...
            <p className="advert-detail">
              Team are generally the biggest expense and always a consideration
              in acquisition, saving costs and driving the business forward.
            </p>
          </div>
          <div className="row">
            <div className="col-md-12">
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are all employees on the same type of contract and termination
                  clauses?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="teamInformation.areEmployeesOnSameContract"
                  onChange={formik.handleChange}
                  value={
                    formik.values.teamInformation.areEmployeesOnSameContract
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
            ...
            <div className="col-md-2">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.teamInformation.employees[0].yearsEmployed
                  }
                  type="number"
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-2">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.teamInformation.employees[1].yearsEmployed
                  }
                  type="number"
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-2">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.teamInformation.employees[2].yearsEmployed
                  }
                  type="number"
                  className="form-control"
                  onChange={formik.handleChange}
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="assets.isCompanyLeaseOfficeSpace"
                  onChange={formik.handleChange}
                  value={formik.values.assets.isCompanyLeaseOfficeSpace}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company have associated financial liabilities, such
                  as leases on equipment, long term phone, car contracts etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="assets.companyHasFinancialAssets"
                  onChange={formik.handleChange}
                  value={formik.values.assets.companyHasFinancialAssets}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company have longer term supply agreements with any
                  business for any activity such as laundry?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="assets.companyHasSupplyAgreements"
                  onChange={formik.handleChange}
                  value={formik.values.assets.companyHasSupplyAgreements}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company have secured loans over the business or
                  debentures of any nature
                </label>
                <Form.Select
                  size="lg"
                  name="assets.companyHasSecureLoans"
                  onChange={formik.handleChange}
                  value={formik.values.assets.companyHasSecureLoans}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company use a trust account for booking income and a
                  separate one for commissions or fees?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="assets.companyUseTrustAcc"
                  onChange={formik.handleChange}
                  value={formik.values.assets.companyUseTrustAcc}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Which merchant card processor does the company use?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="assets.companyMerchantCard"
                  onChange={formik.handleChange}
                  value={formik.values.assets.companyMerchantCard}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="title">
            ...
            <p className="advert-detail">
              Most acquisitions are for growth purposes, creating efficiencies,
              reducing competition, and increasing investment opportunities.
              Brand growth and PR associated with acquisitions are a
              consideration too.
            </p>
          </div>
          <div className="sub-title">
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[0]
                      .numOfProperties2022
                  }
                  type="number"
                  min={0}
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[0].generalType
                  }
                  type="text"
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[1]
                      .numOfProperties2022
                  }
                  type="number"
                  min={0}
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[1].generalType
                  }
                  type="text"
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[2]
                      .numOfProperties2022
                  }
                  type="number"
                  min={0}
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.details[2].generalType
                  }
                  type="text"
                  className="form-control"
                  onChange={formik.handleChange}
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownersAndProperties.ownerHaveSameContract"
                  onChange={formik.handleChange}
                  value={
                    formik.values.ownersAndProperties.ownerHaveSameContract
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownersAndProperties.terminationClauses"
                  onChange={formik.handleChange}
                  value={formik.values.ownersAndProperties.terminationClauses}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownersAndProperties.howRenewed"
                  onChange={formik.handleChange}
                  value={formik.values.ownersAndProperties.howRenewed}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Do you need to agree any yearly terms with owners such as
                  pricing?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="ownersAndProperties.agreeOnYearlyTerm"
                  onChange={formik.handleChange}
                  value={formik.values.ownersAndProperties.agreeOnYearlyTerm}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  What is your customer acquisition cost for properties?{" "}
                </label>
                <input
                  name="ownersAndProperties.customerAquisitionCost"
                  value={
                    formik.values.ownersAndProperties.customerAquisitionCost
                  }
                  type="text"
                  className="form-control"
                  onChange={formik.handleChange}
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  What is the average net profit for each property?{" "}
                </label>
                <input
                  name="ownersAndProperties.avgNetProfitEachProperty"
                  value={
                    formik.values.ownersAndProperties.avgNetProfitEachProperty
                  }
                  type="text"
                  className="form-control"
                  onChange={formik.handleChange}
          ...
          <div className="title">
            <span>
              What types of properties are rented and what is their contribution
              to the business?
            </span>
          </div>
          <div className="sub-title">
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.ownersAndProperties.typesOfRentedProperties
                      .cottages.numOfProperties
                  }
                  type="number"
                  min={0}
                  className="form-control"
          ...
          <div className="title">
            ...
            <p className="advert-detail">
              No one PM has the same business model and an acquirer will
              invariably try to convert it to theirs technically, commercially
              and with owner contracts for consistency.
            </p>
          </div>
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.howPropertiesContracted"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.howPropertiesContracted
                  }
                >
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  How are your cleaning and check in operations organised?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.howCheckOrganised"
                  onChange={formik.handleChange}
                  value={formik.values.baseBuisnessModal.howCheckOrganised}
                >
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company operate a standard commission from each
                  booking approach?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.companyOperateStdCommission"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.companyOperateStdCommission
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isVaryByProperty"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isVaryByProperty
                  }
                >
                  <option value="yes">Yes</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isAnyBookingFees"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isAnyBookingFees
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isListingFeesonTopCommission"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isListingFeesonTopCommission
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are there any additional extras or insurance cover for damage
                  or travel issues?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isAdditionalExtras"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isAdditionalExtras
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company use a deposit and balance model with X days
                  prior to arrival?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isCompanyUseDeposit"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isCompanyUseDeposit
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company take refundable damage deposits?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.isCompanyTakeDamageDeposit"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .isCompanyTakeDamageDeposit
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.commissionStructure.whenOwnersPaid"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.commissionStructure
                      .whenOwnersPaid
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company operate a lease, rent to rent arbitrage model
                  on any properties?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.isCompanyOperateLease"
                  onChange={formik.handleChange}
                  value={formik.values.baseBuisnessModal.isCompanyOperateLease}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  What level of chargebacks has the company experienced over the
                  last 3 years?{" "}
                </label>
                <textarea
                  type="text"
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are there any other financial instruments used to book
                  properties from owners or lessees?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="baseBuisnessModal.anyFinancialInstruments"
                  onChange={formik.handleChange}
                  value={
                    formik.values.baseBuisnessModal.anyFinancialInstruments
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Is there a standard onboarding procedure for a new property?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.isStandardOnboarding"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.isStandardOnboarding}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Do you use external help (e.g. photography, descriptions,
                  interior assistance etc?){" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.doYouUseExternalHelp"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.doYouUseExternalHelp}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.ownerChargedOnboardingFee"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding.ownerChargedOnboardingFee
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.copyrightRetention"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.copyrightRetention}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  {" "}
                  Is the owner given an option on operational management (ie
                  they can choose to do it themselves or will let the company
                  organise it)?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.ownerCanOperationalManagment"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding
                      .ownerCanOperationalManagment
                  }
                >
                  <option value="yes">Yes</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are there pre-meet owner sales collateral pieces, print or
                  pdf?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.premeetOwnerSales"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.premeetOwnerSales}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company offer associated services e.g. Interior
                  design?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.companyOfferAssociatedServices"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding
                      .companyOfferAssociatedServices
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the owner have a say in the pricing, descriptions,
                  photography, which OTAs or anything else?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.ownerHaveSayInPricing"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.ownerHaveSayInPricing}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.ownerApproveLiveListing"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding.ownerApproveLiveListing
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  {" "}
                  Are the owners asked to adopt a particular key entry system
                  e.g.Keyboxes, keyless entry etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.ownerAskedToAdoptEntrySystem"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding
                      .ownerAskedToAdoptEntrySystem
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does a staff member upload the property, set pricing, terms
                  etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.staffMemberUploadProperty"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding.staffMemberUploadProperty
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are channel (OTA) tariff prices uplifted by the commission
                  charged (plus any VAT or card charges)?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.cardCharges"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.cardCharges}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Is there a need to manually add the property to the website or
                  is it all dynamically generated from the PMS?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.howPropertyAdded"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.howPropertyAdded}
                >
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are there any manual actions on the website e.g. SEO such as
                  metatags or H1 titles for each property?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.manualActionsOnWebsite"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding.manualActionsOnWebsite
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.arePropertiesDynamicPricing"
                  onChange={formik.handleChange}
                  value={
                    formik.values.propertyOnboarding.arePropertiesDynamicPricing
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Are there any other manual actions required with a property
                  prior to going live?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="propertyOnboarding.anyManualActions"
                  onChange={formik.handleChange}
                  value={formik.values.propertyOnboarding.anyManualActions}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.totalBookings[0]
                      .year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgNightBookedPerYear[0].year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgNightBookedPerYear[0].year20
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgNightBookedPerYear[0].year21
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgNightBookedPerYear[0].year22
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .customerPercentageRepeatBooking[0].year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .customerPercentageRepeatBooking[0].year20
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .customerPercentageRepeatBooking[0].year21
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .customerPercentageRepeatBooking[0].year22
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.percentGuestCancel[0]
                      .year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgAdvanceBookingWindow[0].year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgAdvanceBookingWindow[0].year20
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgAdvanceBookingWindow[0].year21
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking
                      .avgAdvanceBookingWindow[0].year22
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.avgStayTimes[0].year19
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.avgStayTimes[0].year20
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.avgStayTimes[0].year21
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  value={
                    formik.values.booking.makeupOfBooking.avgStayTimes[0].year22
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  {" "}
                  Are there significant differences in the bookings by
                  OTA/Property type or location. i.e. Booking is mainly urban
                  apartments, Trip is Lodges etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="booking.anySignificantDiff"
                  onChange={formik.handleChange}
                  value={formik.values.booking.anySignificantDiff}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="title">
            <span>Guests</span>
            <p className="advert-detail">
              Once a booking has been made what actions are undertaken…
            </p>
          </div>
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Automation messaging for confirmation of booking and other
                  details, such as balance payment due etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.automationMessaging"
                  onChange={formik.handleChange}
                  value={formik.values.guests.automationMessaging}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Automation messaging for confirmation of the payment?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.automationMessagingForPayment"
                  onChange={formik.handleChange}
                  value={formik.values.guests.automationMessagingForPayment}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Other automated information on location and property?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.automatedInfoOnLocation"
                  onChange={formik.handleChange}
                  value={formik.values.guests.automatedInfoOnLocation}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Link to a guest app which may or may not include 3?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.guestAppLink"
                  onChange={formik.handleChange}
                  value={formik.values.guests.guestAppLink}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="guests.mailedPaperwork"
                  onChange={formik.handleChange}
                  value={formik.values.guests.mailedPaperwork}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Pre arrival information (key access, times, support contact
                  details etc){" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.preArrivalInfo"
                  onChange={formik.handleChange}
                  value={formik.values.guests.preArrivalInfo}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="guests.inStayMessages"
                  onChange={formik.handleChange}
                  value={formik.values.guests.inStayMessages}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Post stay automated messages and review requests?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.postAutomatedMessages"
                  onChange={formik.handleChange}
                  value={formik.values.guests.postAutomatedMessages}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="guests.personalPhoneCalls"
                  onChange={formik.handleChange}
                  value={formik.values.guests.personalPhoneCalls}
                >
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="guests.personalRepeatMarketing"
                  onChange={formik.handleChange}
                  value={formik.values.guests.personalRepeatMarketing}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Do guests have access to a guest login section to see their
                  bookings and entry codes etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="guests.guestHaveAccessToLogin"
                  onChange={formik.handleChange}
                  value={formik.values.guests.guestHaveAccessToLogin}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="guests.guestHaveAccessToMobApp"
                  onChange={formik.handleChange}
                  value={formik.values.guests.guestHaveAccessToMobApp}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownerReporting.ownerReceiveRegularStatement"
                  onChange={formik.handleChange}
                  value={
                    formik.values.ownerReporting.ownerReceiveRegularStatement
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownerReporting.areTailored"
                  onChange={formik.handleChange}
                  value={formik.values.ownerReporting.areTailored}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="ownerReporting.doBookingShowDetails"
                  onChange={formik.handleChange}
                  value={formik.values.ownerReporting.doBookingShowDetails}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Do owners have a separate login or application to access their
                  account?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="ownerReporting.doOwnerHaveSeperateLogin"
                  onChange={formik.handleChange}
                  value={formik.values.ownerReporting.doOwnerHaveSeperateLogin}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="title">
            ...
            <p className="advert-detail">
              Each company has a need for lots of reports, do you do the
              following ones:
            </p>
          </div>
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Reports on bookings: income, filters by properties, groups,
                  dates, booking sources?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.reportsOnBooking"
                  onChange={formik.handleChange}
                  value={formik.values.companyReporting.reportsOnBooking}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Reports on outstanding balances and forward looking cash
                  flows?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.reportsOnBalances"
                  onChange={formik.handleChange}
                  value={formik.values.companyReporting.reportsOnBalances}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Payment reports, payments made, payments to be made, with
                  appropriate filters?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.paymentReports"
                  onChange={formik.handleChange}
                  value={formik.values.companyReporting.paymentReports}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Graphical representations of bookings, ADR, pace etc?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.bookingGraphicalRepresentation"
                  onChange={formik.handleChange}
                  value={
                    formik.values.companyReporting
                      .bookingGraphicalRepresentation
                  }
                >
                  <option value="yes">Yes</option>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Booking splits by OTAs/direct and property segments/groups or
                  individuals with appropriate date filters{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.bookingSplits"
                  onChange={formik.handleChange}
                  value={formik.values.companyReporting.bookingSplits}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Depending on the payment methods and integrations to banking
                  or not, are reconciliation reports generated?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="companyReporting.reconciliationReports"
                  onChange={formik.handleChange}
                  value={formik.values.companyReporting.reconciliationReports}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company use a CRM system such as Hubspot? Or a mail
                  based system, such as MailChimp?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="marketing.companyUseCrm"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.companyUseCrm}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  How frequently does the company undertake a mailer/newsletter{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="marketing.companyUndertakeMailer"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.companyUndertakeMailer}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  What is the response rate to direct marketing to previous
                  guests?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="marketing.directMarketingResponseRate"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.directMarketingResponseRate}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  Does the company actively market to new owners and how?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="marketing.companyActivelyMarket"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.companyActivelyMarket}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                <label>
                  What % of the company income (not gross) spent on marketing?{" "}
                </label>
                <Form.Select
                  size="lg"
                  name="marketing.incomeSpentOnMarketing"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.incomeSpentOnMarketing}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.marketingActivityUndertaken"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.marketingActivityUndertaken}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-10">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.isPrUsed"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.isPrUsed}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.siteAnalysisTools.trafficAnalysis"
                  onChange={formik.handleChange}
                  value={
                    formik.values.marketing.siteAnalysisTools.trafficAnalysis
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.siteAnalysisTools.heatMaps"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.siteAnalysisTools.heatMaps}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.siteAnalysisTools.userTracking"
                  onChange={formik.handleChange}
                  value={formik.values.marketing.siteAnalysisTools.userTracking}
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
                </Form.Select>
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.siteAnalysisTools.keywordAnalysis"
                  onChange={formik.handleChange}
                  value={
                    formik.values.marketing.siteAnalysisTools.keywordAnalysis
                  }
                >
                  <option value="yes">Yes</option>
                  <option value="no">No</option>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                ...
                <Form.Select
                  size="lg"
                  name="marketing.siteAnalysisTools.isPpcAdvertismentUsed"
                  onChange={formik.handleChange}
                  value={
                    formik.values.marketing.siteAnalysisTools
                      .isPpcAdvertismentUsed
                  }
                >
                  <option value="yes">Yes</option>
          ...
          <div className="title">
            <span>Metrics</span>
            <p className="advert-detail">
              Do you track and can you report: (select those that apply)
            </p>
          </div>
          <div className="row">
            <div className="col-md-12">
              <div className="form-check">
                <input
                  ...
                  type="checkbox"
                  name="metrics.webTraffic"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  Web traffic, clicks, conversions?{" "}
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.comparativeBooking"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  Comparative bookings by day/week/month
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.marginsOnBooking"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  Margins on bookings (ADR etc)?
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.npsWithGuest"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  NPS with guests and Staff?
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.reviewsOnWeb"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  Reviews on web and OTAs?
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.companyProfitability"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.personalSatisfaction"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
                  Personal and staff satisfaction?
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-12">
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="checkbox"
                  name="metrics.competitiveAnalysis"
                  onChange={formik.handleChange}
                  value="yes"
                />
                <label className="form-check-label">
          ...
          <div className="title">
            ...
            <p className="advert-detail" style={{ textAlign: "justify" }}>
              Apart from the above, positioning the company for a sale and to
              get the best price will depend on a number of things, most listed
              below. The company will currently have a value but be different,
              depending on the acquirer. There is no real fixed way of assessing
              price, it may be multiple of profit or a per property metric, or
              interest in a location to fill a void or expand which adds a
              premium and all these things need consideration.
            </p>
          </div>
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  Profitability. How much the company makes, how much it could
                  make extra
                </label>
                <textarea
                  type="text"
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  Contracts and owners. How stable and are the contracts solid,
                  although this would be more important in a very litigious
                  country (USA)
                </label>
                <textarea
                  type="text"
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                <label>
                  What are the current arrangements for cleaning and management
                  of the properties and maintenance? This ideally is a list of
                  the properties, their operational support and costs per
                  turnover and the averages per type of property.{" "}
                </label>
                <textarea
                  type="text"
                  name="companyAcquisition.arrangmentsForCleaning"
                  value={
                    formik.values.companyAcquisition.arrangmentsForCleaning
                  }
                  className="form-control"
                  onChange={formik.handleChange}
                  required
