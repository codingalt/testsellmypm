...
const Home = () => {
  ...
  const descript2 =
    "List your PM in front of hundreds of potential buyers. Hire advisors to help manage and close your acquisition. Start conversations that lead to acquisitions in as little as 30 days.";
  const descript1 =
    "Search hundreds of verified PMs, with upfront key STR and financial metrics to find your perfect match. Be ready to make an offer in as little as 3 weeks.";
  const list1 = [
    {
