...
const BuyersPage = () => {
  ...
  const descript1 =
    "Fliter PMs by category, price, and more to find your best match. Evaluate PM efficiency to forecast your return on investment. Need more information? Contact the Property Manager directly through the platform.";
  const descript2 =
    "Measure a PMs past and projected performance using key success metrics, including occupancy, average booking value, number of listings and many more. Estimate your ROI and make better acquisitions.";
  const descript3 =
    "Need help financing your next purchase? We have the network and contacts to help. We can even help you convert future revenues into upfront cash to buy with power. Get approved in as little as 48 hours.";
  const list1 = [
    {
  ...
  const heroTitle =
    "Buy a PM in just 3 weeks. Motivated Sellers. Prepared KPIs. Verified PMs. ";
  const heroDescript =
    "Browse from 100s of PMs for sale, verified and ready to roll. Instantly connect with Property Managers to start the process. Hire approved advisors or skip straight to negotiation. Everything you offer to buy in as little as 3 weeks.";
  const smText =
    "The fastest, easiet way to buy your next property manager business";
