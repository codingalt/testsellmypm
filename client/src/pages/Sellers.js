...
const Sellers = () => {
  ...
  const descript1 = 'Provide the key information buyers will need to evaluate your PM'
  const descript2 = 'Browse the STR’s in-market acquisition advisor directory. Secure your best outcome with professional help, be it taxation, legal, due diligence, M&A and more. Or, go it alone and skip straight to negotiations with buyers. The choice is yours. '
  const descript3 = "Interested buyers will ask you for more details. Once you've exchanged data, finalised negotiations and you're both happy, expect an offer within 3 weeks."
  const list1 = [
    {
  ...
  const heroTitle = 'Sell your PM fast and for the best price. Property Manager friendly. Always anonoymous. No commission.'
  const heroDescript = 'List your details, state your metrics, and get eyes on your PM instantly. Hire approved advisors to help you sell or skip straight to the conversation.'
  const smText = 'The fastest, easiest way to sell your Property Management business'
  ...
  return (
    <div className='home'>
        ...
        <CalltoAction mainTitle={mainTitle} image={cta2} isHeading={true} title={title1} descript={descript1} list={list1} />
        <SellSection isSlider={false} image={cta3} title={title2} descript={descript2} list={list2} />
        <CalltoAction image={cta4} title={title3} descript={descript3} list={list3} />
        <Testimonial />
        <JoinSection />
        <Footer />
    </div>
